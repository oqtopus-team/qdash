...
interface MetricHistoryViewProps {
        ...
        <div className="hidden sm:block mt-3 text-xs text-base-content/60 space-y-1 bg-base-200 p-3 rounded-lg">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              onClick={() => onSelectExecution(selectedItem.execution_id)}
              title="View all tasks in this execution"
            >
          ...
          <div className="pt-2 mt-2 border-t border-base-300">
            <Link
              href={`/provenance?parameter=${encodeURIComponent(metricName)}&qid=${encodeURIComponent(targetId)}&tab=lineage`}
