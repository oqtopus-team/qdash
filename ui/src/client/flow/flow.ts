...
export const useSaveFlow = <TError = HTTPValidationError,
 ...
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getSaveFlowMutationOptions(options), queryClient);
    }
    /**
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetFlowTemplateQueryKey(templateId);
   ...
   return  { queryKey, queryFn, enabled: templateId !== null && templateId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getFlowTemplate>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetFlowHelperFileQueryKey(filename);
   ...
   return  { queryKey, queryFn, enabled: filename !== null && filename !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getFlowHelperFile>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
export const deleteFlowSchedule = (
 ...
 options?: SecondParameter<typeof customInstance>,signal?: AbortSignal
      ...
      {url: `/flows/schedules/${scheduleId}`, method: 'DELETE', signal
    },
      options);
    }
...
export const useDeleteFlowSchedule = <TError = HTTPValidationError,
 ...
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getDeleteFlowScheduleMutationOptions(options), queryClient);
    }
    /**
...
export const updateFlowSchedule = (
 ...
 options?: SecondParameter<typeof customInstance>,signal?: AbortSignal
      ...
      headers: {'Content-Type': 'application/json', },
      data: updateScheduleRequest, signal
    },
      options);
    }
...
export const useUpdateFlowSchedule = <TError = HTTPValidationError,
 ...
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getUpdateFlowScheduleMutationOptions(options), queryClient);
    }
    /**
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetFlowQueryKey(name);
   ...
   return  { queryKey, queryFn, enabled: name !== null && name !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getFlow>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
export const deleteFlow = (
 ...
 options?: SecondParameter<typeof customInstance>,signal?: AbortSignal
      ...
      {url: `/flows/${name}`, method: 'DELETE', signal
    },
      options);
    }
...
export const useDeleteFlow = <TError = HTTPValidationError,
 ...
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getDeleteFlowMutationOptions(options), queryClient);
    }
    /**
...
export const useExecuteFlow = <TError = HTTPValidationError,
 ...
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getExecuteFlowMutationOptions(options), queryClient);
    }
    /**
...
export const useScheduleFlow = <TError = HTTPValidationError,
 ...
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getScheduleFlowMutationOptions(options), queryClient);
    }
    /**
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getListFlowSchedulesQueryKey(name,params);
   ...
   return  { queryKey, queryFn, enabled: name !== null && name !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listFlowSchedules>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
