...
export const getListIssuesQueryOptions = <TData = Awaited<ReturnType<typeof listIssues>>, TError = HTTPValidationError>(params?: ListIssuesParams, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof listIssues>>, TError, TData>>, request?: SecondParameter<typeof customInstance>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getListIssuesQueryKey(params);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof listIssues>>> = ({ signal }) => listIssues(params, requestOptions, signal);
...
export const getGetIssueQueryOptions = <TData = Awaited<ReturnType<typeof getIssue>>, TError = HTTPValidationError>(issueId: string, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getIssue>>, TError, TData>>, request?: SecondParameter<typeof customInstance>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetIssueQueryKey(issueId);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getIssue>>> = ({ signal }) => getIssue(issueId, requestOptions, signal);





   return  { queryKey, queryFn, enabled: issueId !== null && issueId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getIssue>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
export const getDeleteIssueMutationOptions = <TError = HTTPValidationError,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteIssue>>, TError,{issueId: string}, TContext>, request?: SecondParameter<typeof customInstance>}
 ...
 * @summary Delete an issue
 */
export const useDeleteIssue = <TError = HTTPValidationError,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteIssue>>, TError,{issueId: string}, TContext>, request?: SecondParameter<typeof customInstance>}
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getDeleteIssueMutationOptions(options), queryClient);
    }
    /**
...
export const getUpdateIssueMutationOptions = <TError = HTTPValidationError,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateIssue>>, TError,{issueId: string;data: IssueUpdate}, TContext>, request?: SecondParameter<typeof customInstance>}
): UseMutationOptions<Awaited<ReturnType<typeof updateIssue>>, TError,{issueId: string;data: IssueUpdate}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof updateIssue>>, {issueId: string;data: IssueUpdate}> = (props) => {
 ...
 * @summary Update an issue
 */
export const useUpdateIssue = <TError = HTTPValidationError,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateIssue>>, TError,{issueId: string;data: IssueUpdate}, TContext>, request?: SecondParameter<typeof customInstance>}
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getUpdateIssueMutationOptions(options), queryClient);
    }
    /**
...
export const getGetIssueRepliesQueryOptions = <TData = Awaited<ReturnType<typeof getIssueReplies>>, TError = HTTPValidationError>(issueId: string, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getIssueReplies>>, TError, TData>>, request?: SecondParameter<typeof customInstance>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetIssueRepliesQueryKey(issueId);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getIssueReplies>>> = ({ signal }) => getIssueReplies(issueId, requestOptions, signal);





   return  { queryKey, queryFn, enabled: issueId !== null && issueId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getIssueReplies>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
export const closeIssue = (
 ...
 options?: SecondParameter<typeof customInstance>,signal?: AbortSignal
      ...
      return customInstance<SuccessResponse>(
      {url: `/issues/${issueId}/close`, method: 'PATCH', signal
    },
      options);
    }
...
export const getCloseIssueMutationOptions = <TError = HTTPValidationError,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof closeIssue>>, TError,{issueId: string}, TContext>, request?: SecondParameter<typeof customInstance>}
): UseMutationOptions<Awaited<ReturnType<typeof closeIssue>>, TError,{issueId: string}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof closeIssue>>, {issueId: string}> = (props) => {
          const {issueId} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type CloseIssueMutationResult = NonNullable<Awaited<ReturnType<typeof closeIssue>>>
 ...
 * @summary Close an issue
 */
export const useCloseIssue = <TError = HTTPValidationError,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof closeIssue>>, TError,{issueId: string}, TContext>, request?: SecondParameter<typeof customInstance>}
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getCloseIssueMutationOptions(options), queryClient);
    }
    /**
...
export const reopenIssue = (
 ...
 options?: SecondParameter<typeof customInstance>,signal?: AbortSignal
      ...
      return customInstance<SuccessResponse>(
      {url: `/issues/${issueId}/reopen`, method: 'PATCH', signal
    },
      options);
    }
...
export const getReopenIssueMutationOptions = <TError = HTTPValidationError,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof reopenIssue>>, TError,{issueId: string}, TContext>, request?: SecondParameter<typeof customInstance>}
): UseMutationOptions<Awaited<ReturnType<typeof reopenIssue>>, TError,{issueId: string}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof reopenIssue>>, {issueId: string}> = (props) => {
          const {issueId} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type ReopenIssueMutationResult = NonNullable<Awaited<ReturnType<typeof reopenIssue>>>
 ...
 * @summary Reopen an issue
 */
export const useReopenIssue = <TError = HTTPValidationError,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof reopenIssue>>, TError,{issueId: string}, TContext>, request?: SecondParameter<typeof customInstance>}
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getReopenIssueMutationOptions(options), queryClient);
    }
    /**
...
export const getGetTaskResultIssuesQueryKey = (taskId: string,) => {
    return [
    `/task-results/${taskId}/issues`
    ] as const;
    }


export const getGetTaskResultIssuesQueryOptions = <TData = Awaited<ReturnType<typeof getTaskResultIssues>>, TError = HTTPValidationError>(taskId: string, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getTaskResultIssues>>, TError, TData>>, request?: SecondParameter<typeof customInstance>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetTaskResultIssuesQueryKey(taskId);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getTaskResultIssues>>> = ({ signal }) => getTaskResultIssues(taskId, requestOptions, signal);





   return  { queryKey, queryFn, enabled: taskId !== null && taskId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getTaskResultIssues>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
export const getCreateIssueMutationOptions = <TError = HTTPValidationError,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createIssue>>, TError,{taskId: string;data: IssueCreate}, TContext>, request?: SecondParameter<typeof customInstance>}
): UseMutationOptions<Awaited<ReturnType<typeof createIssue>>, TError,{taskId: string;data: IssueCreate}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof createIssue>>, {taskId: string;data: IssueCreate}> = (props) => {
...
export const useCreateIssue = <TError = HTTPValidationError,
 ...
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getCreateIssueMutationOptions(options), queryClient);
    }
