...
export const useCreateCooldown = <TError = HTTPValidationError,
 ...
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getCreateCooldownMutationOptions(options), queryClient);
    }
    /**
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetCooldownQueryKey(cooldownId);
   ...
   return  { queryKey, queryFn, enabled: cooldownId !== null && cooldownId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getCooldown>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
export const updateCooldown = (
 ...
 options?: SecondParameter<typeof customInstance>,signal?: AbortSignal
      ...
      headers: {'Content-Type': 'application/json', },
      data: cooldownUpdateRequest, signal
    },
      options);
    }
...
export const useUpdateCooldown = <TError = HTTPValidationError,
 ...
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getUpdateCooldownMutationOptions(options), queryClient);
    }
    /**
...
export const deleteCooldown = (
 ...
 options?: SecondParameter<typeof customInstance>,signal?: AbortSignal
      ...
      {url: `/cooldowns/${cooldownId}`, method: 'DELETE', signal
    },
      options);
    }
...
export const useDeleteCooldown = <TError = HTTPValidationError,
 ...
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getDeleteCooldownMutationOptions(options), queryClient);
    }
    /**
...
export const useAssignChipToCooldown = <TError = HTTPValidationError,
 ...
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getAssignChipToCooldownMutationOptions(options), queryClient);
    }
    /**
...
export const unassignChipFromCooldown = (
 ...
 options?: SecondParameter<typeof customInstance>,signal?: AbortSignal
      ...
      return customInstance<CooldownResponse>(
      {url: `/cooldowns/${cooldownId}/chips/${chipId}`, method: 'DELETE', signal
    },
      options);
    }
...
export const useUnassignChipFromCooldown = <TError = HTTPValidationError,
 ...
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getUnassignChipFromCooldownMutationOptions(options), queryClient);
    }
