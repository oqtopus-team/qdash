...
export const useGetDeviceTopology = <TError = HTTPValidationError,
 ...
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getGetDeviceTopologyMutationOptions(options), queryClient);
    }
    /**
...
export const useGetDeviceTopologyPlot = <TError = HTTPValidationError,
 ...
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getGetDeviceTopologyPlotMutationOptions(options), queryClient);
    }
