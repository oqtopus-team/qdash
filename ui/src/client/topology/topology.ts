...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetTopologyByIdQueryKey(topologyId);
   ...
   return  { queryKey, queryFn, enabled: topologyId !== null && topologyId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getTopologyById>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
