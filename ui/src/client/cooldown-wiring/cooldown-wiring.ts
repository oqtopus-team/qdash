...
export const useCreateCooldownWiringCheckpoint = <TError = HTTPValidationError,
 ...
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getCreateCooldownWiringCheckpointMutationOptions(options), queryClient);
    }
    /**
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getListCooldownWiringEventsQueryKey(cooldownId,params);
   ...
   return  { queryKey, queryFn, enabled: cooldownId !== null && cooldownId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listCooldownWiringEvents>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
