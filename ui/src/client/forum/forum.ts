...
export const useCreateForumCategory = <TError = HTTPValidationError,
 ...
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getCreateForumCategoryMutationOptions(options), queryClient);
    }
    /**
...
export const updateForumCategory = (
 ...
 options?: SecondParameter<typeof customInstance>,signal?: AbortSignal
      ...
      headers: {'Content-Type': 'application/json', },
      data: forumCategoryUpdate, signal
    },
      options);
    }
...
export const useUpdateForumCategory = <TError = HTTPValidationError,
 ...
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getUpdateForumCategoryMutationOptions(options), queryClient);
    }
    /**
...
export const deleteForumCategory = (
 ...
 options?: SecondParameter<typeof customInstance>,signal?: AbortSignal
      ...
      {url: `/forum/categories/${categoryKey}`, method: 'DELETE', signal
    },
      options);
    }
...
export const useCreateForumPost = <TError = HTTPValidationError,
 ...
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getCreateForumPostMutationOptions(options), queryClient);
    }
    /**
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetForumPostQueryKey(postId);
   ...
   return  { queryKey, queryFn, enabled: postId !== null && postId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getForumPost>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
export const useUpdateForumPost = <TError = HTTPValidationError,
 ...
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getUpdateForumPostMutationOptions(options), queryClient);
    }
    /**
...
export const deleteForumPost = (
 ...
 options?: SecondParameter<typeof customInstance>,signal?: AbortSignal
      ...
      return customInstance<SuccessResponse>(
      {url: `/forum/posts/${postId}`, method: 'DELETE', signal
    },
      options);
    }
...
export const useDeleteForumPost = <TError = HTTPValidationError,
 ...
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getDeleteForumPostMutationOptions(options), queryClient);
    }
    /**
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetForumPostRepliesQueryKey(postId,params);
   ...
   return  { queryKey, queryFn, enabled: postId !== null && postId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getForumPostReplies>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
formData.append(`file`, bodyUploadForumImage.file);
      ...
      return customInstance<ForumImageUploadResponse>(
...
export const getUploadForumImageMutationOptions = <TError = void | HTTPValidationError,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof uploadForumImage>>, TError,{data: BodyUploadForumImage}, TContext>, request?: SecondParameter<typeof customInstance>}
): UseMutationOptions<Awaited<ReturnType<typeof uploadForumImage>>, TError,{data: BodyUploadForumImage}, TContext> => {

const mutationKey = ['uploadForumImage'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type UploadForumImageMutationResult = NonNullable<Awaited<ReturnType<typeof uploadForumImage>>>
    export type UploadForumImageMutationBody = BodyUploadForumImage
    export type UploadForumImageMutationError = void | HTTPValidationError

    /**
 * @summary Upload an image for a forum post
 */
export const useUploadForumImage = <TError = void | HTTPValidationError,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof uploadForumImage>>, TError,{data: BodyUploadForumImage}, TContext>, request?: SecondParameter<typeof customInstance>}
 , queryClient?: QueryClient): UseMutationResult<
        Awaited<ReturnType<typeof uploadForumImage>>,
        TError,
        {data: BodyUploadForumImage},
        TContext
      > => {
      return useMutation(getUploadForumImageMutationOptions(options), queryClient);
    }
    /**
...
export const closeForumPost = (
 ...
 options?: SecondParameter<typeof customInstance>,signal?: AbortSignal
      ...
      return customInstance<SuccessResponse>(
      {url: `/forum/posts/${postId}/close`, method: 'PATCH', signal
    },
      options);
    }
...
export const useCloseForumPost = <TError = HTTPValidationError,
 ...
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getCloseForumPostMutationOptions(options), queryClient);
    }
    /**
...
export const reopenForumPost = (
 ...
 options?: SecondParameter<typeof customInstance>,signal?: AbortSignal
      ...
      return customInstance<SuccessResponse>(
      {url: `/forum/posts/${postId}/reopen`, method: 'PATCH', signal
    },
      options);
    }
...
export const useReopenForumPost = <TError = HTTPValidationError,
 ...
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getReopenForumPostMutationOptions(options), queryClient);
    }
