...
export const useImportSeedParameters = <TError = HTTPValidationError,
 ...
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getImportSeedParametersMutationOptions(options), queryClient);
    }
    /**
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetAvailableSeedParametersQueryKey(chipId);
   ...
   return  { queryKey, queryFn, enabled: chipId !== null && chipId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getAvailableSeedParameters>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getCompareSeedValuesQueryKey(chipId,params);
   ...
   return  { queryKey, queryFn, enabled: chipId !== null && chipId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof compareSeedValues>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
export const updateCalibrationParameters = (
 ...
 options?: SecondParameter<typeof customInstance>,signal?: AbortSignal
      ...
      headers: {'Content-Type': 'application/json', },
      data: manualParameterUpdateRequest, signal
    },
      options);
    }
...
export const useUpdateCalibrationParameters = <TError = HTTPValidationError,
 ...
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getUpdateCalibrationParametersMutationOptions(options), queryClient);
    }
    /**
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetManualEditsQueryKey(qid);
   ...
   return  { queryKey, queryFn, enabled: qid !== null && qid !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getManualEdits>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
