...
export const listTaskResults = (
 ...
 options?: SecondParameter<typeof customInstance>,signal?: AbortSignal
      ...
      return customInstance<TaskResultListResponse>(
...
export const getListTaskResultsQueryKey = (params?: ListTaskResultsParams,) => {
    return [
    `/task-results`, ...(params ? [params] : [])
    ] as const;
    }


export const getListTaskResultsQueryOptions = <TData = Awaited<ReturnType<typeof listTaskResults>>, TError = HTTPValidationError>(params?: ListTaskResultsParams, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof listTaskResults>>, TError, TData>>, request?: SecondParameter<typeof customInstance>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getListTaskResultsQueryKey(params);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof listTaskResults>>> = ({ signal }) => listTaskResults(params, requestOptions, signal);
...
export type ListTaskResultsQueryError = HTTPValidationError


export function useListTaskResults<TData = Awaited<ReturnType<typeof listTaskResults>>, TError = HTTPValidationError>(
 params: undefined |  ListTaskResultsParams, options: { query:Partial<UseQueryOptions<Awaited<ReturnType<typeof listTaskResults>>, TError, TData>> & Pick<
        DefinedInitialDataOptions<
          Awaited<ReturnType<typeof listTaskResults>>,
          TError,
          Awaited<ReturnType<typeof listTaskResults>>
        > , 'initialData'
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetQubitTaskHistoryQueryKey(qid,params);
   ...
   return  { queryKey, queryFn, enabled: qid !== null && qid !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getQubitTaskHistory>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetCouplingTaskHistoryQueryKey(couplingId,params);
   ...
   return  { queryKey, queryFn, enabled: couplingId !== null && couplingId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getCouplingTaskHistory>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetTaskResultAiReviewRunQueryKey(reviewRunId);
   ...
   return  { queryKey, queryFn, enabled: reviewRunId !== null && reviewRunId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getTaskResultAiReviewRun>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
export const useRequestBulkAiReview = <TError = HTTPValidationError,
 ...
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getRequestBulkAiReviewMutationOptions(options), queryClient);
    }
    /**
...
const {mutation: mutationOptions, request: requestOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type ReExecuteTaskResultMutationBody = BodyReExecuteTaskResult | undefined
...
export const useReExecuteTaskResult = <TError = HTTPValidationError,
 ...
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getReExecuteTaskResultMutationOptions(options), queryClient);
    }
    /**
...
export const useSetTaskResultExcluded = <TError = HTTPValidationError,
 ...
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getSetTaskResultExcludedMutationOptions(options), queryClient);
    }
    /**
...
export const useDownloadFiguresAsZip = <TError = HTTPValidationError,
 ...
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getDownloadFiguresAsZipMutationOptions(options), queryClient);
    }
