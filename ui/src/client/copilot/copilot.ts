...
export const useAnalyzeCopilot = <TError = HTTPValidationError,
 ...
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getAnalyzeCopilotMutationOptions(options), queryClient);
    }
    /**
...
export const useCreateCopilotChatSession = <TError = HTTPValidationError,
 ...
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getCreateCopilotChatSessionMutationOptions(options), queryClient);
    }
    /**
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetCopilotChatSessionQueryKey(sessionId);
   ...
   return  { queryKey, queryFn, enabled: sessionId !== null && sessionId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getCopilotChatSession>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
export const updateCopilotChatSession = (
 ...
 options?: SecondParameter<typeof customInstance>,signal?: AbortSignal
      ...
      headers: {'Content-Type': 'application/json', },
      data: updateCopilotChatSessionRequest, signal
    },
      options);
    }
...
export const useUpdateCopilotChatSession = <TError = HTTPValidationError,
 ...
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getUpdateCopilotChatSessionMutationOptions(options), queryClient);
    }
    /**
...
export const deleteCopilotChatSession = (
 ...
 options?: SecondParameter<typeof customInstance>,signal?: AbortSignal
      ...
      {url: `/copilot/chat/sessions/${sessionId}`, method: 'DELETE', signal
    },
      options);
    }
...
export const useDeleteCopilotChatSession = <TError = HTTPValidationError,
 ...
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TContext
      > => {
      return useMutation(getDeleteCopilotChatSessionMutationOptions(options), queryClient);
    }
