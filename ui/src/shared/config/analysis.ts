...
export const THRESHOLD_RANGES: Record<string, { min: number; max: number; step: number }> = {
  t1: { min: 50, max: 200, step: 1 },
  t2_echo: { min: 100, max: 400, step: 1 },
  t2_star: { min: 25, max: 100, step: 1 },
  // Fidelity parameters (as raw values, converted in UI)
  gate_fidelity: { min: 0.90, max: 0.999, step: 0.001 },
  x90_fidelity: { min: 0.90, max: 0.999, step: 0.001 },
  x180_fidelity: { min: 0.90, max: 0.999, step: 0.001 },
  zx90_fidelity: { min: 0.90, max: 0.999, step: 0.001 },
  bell_state_fidelity: { min: 0.80, max: 0.999, step: 0.001 },
  readout_fidelity: { min: 0.90, max: 0.999, step: 0.001 },
};

// Error rate ranges (for error rate display mode)
export const ERROR_RATE_RANGES: Record<string, { min: number; max: number; step: number }> = {
...
export function getParameterRange(parameter: string, showAsErrorRate: boolean = false) {
