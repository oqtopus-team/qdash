...
class Task:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_output_parameters(
            data: object,
        ) -> Union["TaskOutputParametersType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        output_parameter_names = _parse_output_parameter_names(
            d.pop("output_parameter_names", UNSET)
        )
