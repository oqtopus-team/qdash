...
class UpdateMenuRequest:
    ...
    Attributes:
        ...
        task_details (Union['UpdateMenuRequestTaskDetailsType0', None, Unset]):
    ...
    task_details: Union["UpdateMenuRequestTaskDetailsType0", None, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.task_details, Unset):
            task_details = UNSET
        elif isinstance(self.task_details, UpdateMenuRequestTaskDetailsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_task_details(data: object) -> Union["UpdateMenuRequestTaskDetailsType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                task_details_type_0 = UpdateMenuRequestTaskDetailsType0.from_dict(data)

                return task_details_type_0
            except:  # noqa: E722
                pass
            return cast(Union["UpdateMenuRequestTaskDetailsType0", None, Unset], data)
        ...
        update_menu_request.additional_properties = d
        return update_menu_request
