 ...
 */
const checkExecutionAvailability = (
    executionAvailabilityRequest: ExecutionAvailabilityRequest,
 options?: SecondParameter<typeof qdashRequest<ExecutionAvailabilityResponse>>,) => {
      return qdashRequest<ExecutionAvailabilityResponse>(
 ...
 */
const retryCalibrationGitHubSync = (
    taskId: string,
 options?: SecondParameter<typeof qdashRequest<CalibrationGitHubSync>>,) => {
      return qdashRequest<CalibrationGitHubSync>(
      {url: `/calibrations/manual-edits/${taskId}/github-sync`, method: 'POST'
    },
      options);
    }
...
const downloadMetricsPdf = (
 ...
 options?: SecondParameter<typeof qdashRequest<unknown | Blob>>,) => {
      return qdashRequest<unknown | Blob>(
...
export type CheckExecutionAvailabilityResult = NonNullable<Awaited<ReturnType<ReturnType<typeof getQDashAPI>['checkExecutionAvailability']>>>
...
export type RetryCalibrationGitHubSyncResult = NonNullable<Awaited<ReturnType<ReturnType<typeof getQDashAPI>['retryCalibrationGitHubSync']>>>
