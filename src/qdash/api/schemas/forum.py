...
class ForumPostCreate(BaseModel):
    ...
    status: ForumThreadStatus = Field(default="open", description="Thread workflow status")
...
class ForumPostUpdate(BaseModel):
    ...
    status: ForumThreadStatus | None = Field(
        default=None, description="Updated thread workflow status"
    )
