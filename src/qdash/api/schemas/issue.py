...
class IssueAiReplyRequest(BaseModel):
    """Request schema for AI reply in an issue thread."""

    user_message: str = Field(..., min_length=1, max_length=5000, description="User message to AI")
