...
T = TypeVar("T", bound="TaskResponseOutputParameters")


@_attrs_define
class TaskResponseOutputParameters:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        task_response_output_parameters = cls()
        ...
        task_response_output_parameters.additional_properties = additional_properties
        return task_response_output_parameters
