...
class CreateMenuRequest:
    ...
    Example:
        {'backend': 'qubex', 'batch_mode': False, 'description': 'This is a sample menu item.', 'name': 'CheckOneQubit',
            'notify_bool': False, 'qids': [['28', '29']], 'tags': ['debug'], 'tasks': ['CheckStatus', 'DumpBox',
            'CheckNoise', 'CheckRabi', 'CreateHPIPulse', 'CheckHPIPulse', 'CreatePIPulse', 'CheckPIPulse', 'CheckT1',
    ...
    Attributes:
        ...
        task_details (Union['CreateMenuRequestTaskDetailsType0', None, Unset]):
    ...
    task_details: Union["CreateMenuRequestTaskDetailsType0", None, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.task_details, Unset):
            task_details = UNSET
        elif isinstance(self.task_details, CreateMenuRequestTaskDetailsType0):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        def _parse_task_details(data: object) -> Union["CreateMenuRequestTaskDetailsType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                task_details_type_0 = CreateMenuRequestTaskDetailsType0.from_dict(data)

                return task_details_type_0
            except:  # noqa: E722
                pass
            return cast(Union["CreateMenuRequestTaskDetailsType0", None, Unset], data)
        ...
        create_menu_request.additional_properties = d
        return create_menu_request
