...
if TYPE_CHECKING:
    ...
    from ..models.execute_calib_request_task_details_type_0 import ExecuteCalibRequestTaskDetailsType0
    from ..models.parallel_node import ParallelNode
    from ..models.serial_node import SerialNode


T = TypeVar("T", bound="ExecuteCalibRequest")


@_attrs_define
class ExecuteCalibRequest:
    ...
    Attributes:
        ...
        task_details (Union['ExecuteCalibRequestTaskDetailsType0', None, Unset]):
    ...
    task_details: Union["ExecuteCalibRequestTaskDetailsType0", None, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.task_details, Unset):
            task_details = UNSET
        elif isinstance(self.task_details, ExecuteCalibRequestTaskDetailsType0):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        def _parse_task_details(data: object) -> Union["ExecuteCalibRequestTaskDetailsType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                task_details_type_0 = ExecuteCalibRequestTaskDetailsType0.from_dict(data)

                return task_details_type_0
            except:  # noqa: E722
                pass
            return cast(Union["ExecuteCalibRequestTaskDetailsType0", None, Unset], data)
        ...
        execute_calib_request.additional_properties = d
        return execute_calib_request
