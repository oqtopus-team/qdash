...
class ConfigurationManager:
    ...
    def get_model_configs(self) -> Dict[str, ModelConfig]:
        ...
        return {
            ...
            "gpt-5": ModelConfig(
                name="gpt-5", provider="openai", max_completion_tokens=4000, 
                temperature=0.3, timeout_seconds=30
            ),
            "gpt-5-mini": ModelConfig(
                name="gpt-5-mini", provider="openai", max_completion_tokens=4000, 
                temperature=0.3, timeout_seconds=20
            ),
            "gpt-5-nano": ModelConfig(
                name="gpt-5-nano", provider="openai", max_completion_tokens=2000, 
                temperature=0.3, timeout_seconds=15
            ),
            "gpt-5-chat-latest": ModelConfig(
                name="gpt-5-chat-latest", provider="openai", max_completion_tokens=4000, 
                temperature=0.3, timeout_seconds=25
            ),
            
            # GPT-4 family
            "gpt-4o": ModelConfig(
                name="gpt-4o", provider="openai", max_completion_tokens=4000, 
                temperature=0.3, timeout_seconds=30
            ),
            "gpt-4o-mini": ModelConfig(
                name="gpt-4o-mini", provider="openai", max_completion_tokens=4000, 
                temperature=0.3, timeout_seconds=20
            ),
            "gpt-4-turbo": ModelConfig(
                name="gpt-4-turbo", provider="openai", max_completion_tokens=4000, 
                temperature=0.3, timeout_seconds=30
            ),
            
            # Claude family
            "claude-3-5-sonnet": ModelConfig(
                name="claude-3-5-sonnet-20241022", provider="anthropic", max_completion_tokens=4000, 
                temperature=0.3, timeout_seconds=30
            ),
            "claude-3-haiku": ModelConfig(
                name="claude-3-haiku-20240307", provider="anthropic", max_completion_tokens=4000, 
                temperature=0.3, timeout_seconds=15
            ),
        }
    ...
    def get_health_info(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "features_enabled": [
                name for name, value in asdict(config.features).items() if value
            ],
