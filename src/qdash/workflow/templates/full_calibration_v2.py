...
This template demonstrates the new step-based calibration API.

Execution flow:
    1. OneQubitCheck: Basic 1Q characterization (Rabi, HPI, T1, T2, Ramsey)
    2. OneQubitFineTune: Advanced 1Q calibration (DRAG, RB, X90 IRB)
    3. FilterByMetric: Filter by X90 fidelity threshold
    4. GenerateCRSchedule: Generate 2Q execution schedule
    5. TwoQubitCalibration: 2Q coupling calibration
