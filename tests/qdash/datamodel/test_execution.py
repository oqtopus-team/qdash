...
class TestExecutionModelDatetimeValidation:
    ...
    @pytest.fixture
    def minimal_execution_data(self) -> dict:
    ...
    def test_start_at_from_datetime(self, minimal_execution_data: dict) -> None:
    ...
    def test_start_at_naive_datetime_becomes_utc(self, minimal_execution_data: dict) -> None:
    ...
    def test_start_at_none(self, minimal_execution_data: dict) -> None:
        """Test start_at accepts None."""
        model = ExecutionModel(**minimal_execution_data, start_at=None)
        assert model.start_at is None

    def test_end_at_from_datetime(self, minimal_execution_data: dict) -> None:
    ...
    def test_elapsed_time_from_timedelta(self, minimal_execution_data: dict) -> None:
    ...
    def test_elapsed_time_from_string(self, minimal_execution_data: dict) -> None:
        """Test elapsed_time accepts string format."""
        model = ExecutionModel(**minimal_execution_data, elapsed_time="1:30:00")
        assert model.elapsed_time == timedelta(hours=1, minutes=30)

    def test_elapsed_time_from_float(self, minimal_execution_data: dict) -> None:
        """Test elapsed_time accepts float (seconds)."""
        model = ExecutionModel(**minimal_execution_data, elapsed_time=5400.0)
        assert model.elapsed_time == timedelta(seconds=5400)

    def test_elapsed_time_none(self, minimal_execution_data: dict) -> None:
